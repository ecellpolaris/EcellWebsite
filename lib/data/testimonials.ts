...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    quote:
      "My mission at Polaris is to ensure every student finds their highest trajectory, and E Cell is where that ambition turns into tangible reality. The collaborative culture here is unmatched. Seniors mentor juniors at 2 AM, cross disciplinary teams ship hackathon MVPs in 48 hours, and an unconditional support network thrives. E Cell does not just produce founders; it builds resilient leaders who know how to win.",
    author: "Rohan Saneja",
