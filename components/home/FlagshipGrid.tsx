...
export const FlagshipGrid: React.FC = () => {
  const flagships = [
    ...
    },
    {
      ...
      statusVariant: "lime" as const,
      tagline: "Selected student founders pitch to industry mentors for seed funding and direct paid internships.",
      metric: "Funding & Internships",
    ...
    {
      title: "Polaris Fellowship",
      theme: "6-MONTH IMMERSION",
      status: "Already done" as const,
      statusVariant: "outline" as const,
      tagline: "Connecting exceptional student builders with leading startups and technology companies in Bengaluru.",
      metric: "6-Month Cohort",
      href: "/programs/polaris-fellowship",
