...
export const WhatWeDo: React.FC = () => {
  const pillars = [
    ...
    },
    {
      ...
      tag: "COMPETITIONS & ROASTS",
      desc: "We don't clap for polite PowerPoint decks. Enter IGNITE and face a room of cynical angel operators who will tear down your schema, CAC, and conversion rate.",
      bulletPoints: [
        "Quarterly IGNITE Pitch Leagues",
        "Live 5-minute product teardowns",
        "Non-dilutive cash cheques",
      ],
      icon: <Swords className="w-5 h-5 text-ink" />,
      link: "/programs/ignite",
      linkText: "Enter the league",
    },
    {
      num: "03",
      title: "Stay in the building",
      tag: "PRE-INCUBATION & CAPITAL",
      desc: "An 8-week structured FORGE sprint where teams write production code, talk to 50 real customers, get cloud credits, and pitch to institutional seed funds.",
      bulletPoints: [
        "Weekly Saturday code audits",
        "1-on-1 Founder Hours slots",
        "Bengaluru seed investor intros",
      ],
      icon: <Building2 className="w-5 h-5 text-ink" />,
      link: "/programs/forge",
      linkText: "Apply to FORGE",
    },
  ];
